	...
	return (
		<div className="footer-cont">
			<div className="footer-text">
				<h4>Contact Us</h4>
				<a href="mailto:hello@estoniaexp.com" target="_blank" rel="noreferrer">
					hello@estoniaexp.com
				</a>
				<br />
				<p>Estonia Experience © 2018-2022</p>
				<p className="footer-author">
					Website built by{" "}
					<a href="https://carlosmiceli.com/" target="_blank" rel="noreferrer">
						Charly
					</a>
				</p>
			</div>
