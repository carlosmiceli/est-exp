...
const Sell = () => {
	...
	return (
		<div className="sell-cont">
			...
			<div
				className={`modal-apply ${openModalApply ? "modal-apply-open" : ""}`}
			>
				<div className="modal-apply-filter">
					<h4 className="modal-apply-text">
						Thank you for applying to Estonia Experience! <br /> We will be in
						touch with you soon.
					</h4>
				</div>
			</div>
			<div className="sell-cols">
				<div className="sell-option">
					...
					<div className={`${apply ? "apply-disappear" : "apply-visible"}`}>
						<button onClick={switchApply} className="apply-button">
							Apply
						</button>
					</div>
					<div
						className={`${
							apply ? "application-visible" : "application-hidden"
						}`}
					>
						<Form onSubmit={handleSubmit}>
							<Form.Group controlId="application-form">
								...
								<Form.Control
									value={undefined}
									type="text"
									placeholder="Phone/Whatsapp (add area code)"
									required
								/>
								<Form.Control
									value={undefined}
				...
				<div className="sell-option">
					...
					<div className="sell-description">
						<p>
							Customized private trips for companies, associations and schools.
						</p>
						<p>
							<a href="#contact-us">Fill the form</a> or inquire at{" "}
							<a href="mailto:hello@estoniaexp.com" target="_blank">
								hello@estoniaexp.com
							</a>{" "}
